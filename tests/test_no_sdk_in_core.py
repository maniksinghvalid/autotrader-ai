...
def test_core_imports_do_not_load_moomoo_sdk():
    code = (
        ...
        "          'autotrader.strategies.threshold', 'autotrader.sizing',\n"
        "          'autotrader.main',\n"
        ...
        "          'autotrader.books',\n"
        "          'autotrader.backtest.data', 'autotrader.backtest.engine',\n"
        "          'autotrader.backtest.metrics', 'autotrader.backtest.report',\n"
        "          'autotrader.backtest.sweep', 'autotrader.strategies.pullback',\n"
