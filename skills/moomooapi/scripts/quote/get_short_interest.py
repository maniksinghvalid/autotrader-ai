...
Usage: python get_short_interest.py [-h] [--next-key NEXT_KEY] [--num MAX_COUNT] [--json] code
...
def get_short_interest(code, next_key=None, max_count=None, output_json=False):
    ctx = None
    try:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num", type=int, default=None, dest="max_count",
                        help="Number of results per page, default 10, range 1-50")
    parser.add_argument("--json", action="store_true", dest="output_json",
                        help="Output in JSON format")
    args = parser.parse_args()
    get_short_interest(args.code, next_key=args.next_key, max_count=args.max_count,
