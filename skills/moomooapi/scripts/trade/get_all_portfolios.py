...
def query_portfolio(host, port, acc_id, trd_env, asset_cat_enum=None):
...
def main():
    ...
    for acc in accounts:
        ...
        funds, positions = query_portfolio(host, port, acc_id, trd_env, asset_cat_enum=asset_cat_enum)
        results.append({
            "acc_id": acc_id,
            "trd_env": trd_env_str,
